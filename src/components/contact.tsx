            ...
            <div className="animated-border-content">
              <div className="flex flex-col items-center text-center p-8">
                ...
                <div className="flex items-center gap-2 text-gray-500 text-sm mb-6">
                  ...
                  <span className="font-mono">max.decamps@std.heh.be</span>
                </div>
                <Button
                  asChild
                  size="lg"
                  className="bg-white text-black font-bold h-12 md:h-14 text-sm md:text-base tracking-wider transition-all duration-200 hover:shadow-[9px_9px_33px_#d1d1d1,-9px_-9px_33px_rgba(255,255,255,0.3)] hover:-translate-y-0.5 border-none mb-4"
